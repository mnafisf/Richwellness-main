    ...
    <div class="main">
        <div class="auth-card">
            ...
            <div class="form-side">
                ...
                <p class="text-center text-muted mb-4" style="font-size: 14px; margin-top: -15px; color: #a79d8c;">Bergabunglah untuk mendapatkan akses ke layanan eksklusif kami</p>
            ...
            <div class="image-side">
                <div class="image-content">
                    <h2>Bergabung dengan Rich Wellness</h2>
                    <p>Menjadi bagian dari pengalaman kemewahan spa premium kami. Rasakan sentuhan ketenangan dan layanan eksklusif untuk keseimbangan jiwa dan raga Anda.</p>
                </div>
            </div>
        </div>
    </div>
